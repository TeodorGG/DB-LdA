                ...
                <div class="d-flex justify-content-between" style = "margin-top: 30px;">
                    <div class = "w-100 " >
                        ...
                        <table class = "table">
                            ...
                            ?>
                                <tr onclick = "<?php echo "window.location.replace('http://localhost:8888/tezadean/index.php?get_user_data=".$row['f2']."&name=".$row['f3']."')"?>" >
        ...
        <div class="row">
            ...
            <div class="col-md-8 ">
                ...
                <div  class = "d-flex flex-row">
                    ...
                    <button class = "btn btn-dark btn-square-md m-auto" onClick = "update_chart()">Fi ltrează</button>
