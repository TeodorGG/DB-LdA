...
<?php $con = new mysqli("localhost","root","root","finante"); ?>
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8888/tezadean/css/style.css">
        ...
        <div class="d-flex justify-content-between">
                <div class = "w-100  d-flex flex-column justify-content-center">
                    ...
                    <form action="process.php" method = "GET" style = "d-flex flex-row justify-content-center">
                        <input name="nume_membru" placeholder = "Nume membru nou" style = "width : 100%; "  minlength = "4" type required/>
        ...
        <div class="d-flex justify-content-between">
                <div class = "w-100  d-flex flex-column justify-content-center">
                    ...
                    <form action="http://localhost:8888/tezadean/process.php" method = "GET" style = "d-flex flex-row justify-content-center">
                        <input name="titlu_venit" value = "<?php if($id_edit_venit != ""){echo $venit_data['titlu'];} else { echo " "; }?>"  placeholder = "Titlu" style = "width : 100%; margin-top:20px"  minlength = "4" type required/>
                        <input name="valoare"  value = "<?php if($id_edit_venit != ""){echo $venit_data['val_venit'];} else { echo " "; }?>"  placeholder = "Valoare" style = "width : 100%;  margin-top:20px"   required/>
                        <?php if($id_edit_venit != ""){ echo '
                            <input name="id_update_venit" value = "'.$id_edit_venit.'"  style = "display: none; " />
                            '; }?>
                        <select id="id_membru" name="id_membru" style = "width : 100%;  margin-top:20px" required>
                        ...
                        <input name="date"  value = "<?php if($id_edit_venit != ""){echo $venit_data['date'];} else { echo " "; }?>"   placeholder = "Data" style = "width : 100%;  margin-top:20px" type="date"   required/>
                        <select id="id_tip" name="id_tip" style = "width : 100%;  margin-top:20px" required>
                        ...
                        <select id="id_sursa" name="id_sursa" style = "width : 100%;  margin-top:20px" required>
                        ...
                        <div class = "d-flex flex-row">
                            <a href="http://localhost:8888/tezadean/index.php" class="btn btn-danger w-100" style="margin: 5px;">Anulează</a>
    ...
    <div class = "dialog_container">
        <div class="d-flex justify-content-between">
                <div class = "w-100  d-flex flex-column justify-content-center">
                    ...
                    <form action="http://localhost:8888/tezadean/process.php" method = "GET" style = "d-flex flex-row justify-content-center">
                        <input name="titlu_cheltuiala" value = "<?php if($id_edit_cheltuiala != ""){echo $cheltuieli_data['titlu'];} else { echo " "; }?>"      placeholder = "Titlu" style = "width : 100%; margin-top:20px"  minlength = "4" type required/>
                        <input name="valoare<?php if($id_edit_cheltuiala != ''){echo "_update";}?>"          value = "<?php if($id_edit_cheltuiala != ""){echo $cheltuieli_data['val_cheltuili'];} else { echo " "; }?>"       placeholder = "Valoare" style = "width : 100%;  margin-top:20px"   required/>
                        ...
                        <input name="date"  value = "<?php if($id_edit_cheltuiala != ""){echo $cheltuieli_data['date'];} else { echo " "; }?>"   placeholder = "Data" style = "width : 100%;  margin-top:20px" type="date"   required/>
                        <select id="id_tip" name="id_tip" style = "width : 100%;  margin-top:20px" required>
                        ...
                        <select id="id_categorie" name="id_categorie" style = "width : 100%;  margin-top:20px" required>
    ...
    <div class = "dialog_box" id = "user_info" >
        <div class = "dialog_container" style = "z-index : 999">
            <div class = "d-flex flex-row justify-space-between">
                <h3 class = "w-100" style = "width : 100%">Datele utilizatorului: <?php echo $_SESSION['alert_name'] ?></h3>
                            ...
                            ?>
                                ...
                                <tr>
                                    <td colspan="3" style = "border-top: none; ">
                                        <div class = "d-flex flex-row">
                                            <a href="index.php?edit_cheltuiala=<?php echo $row['id_chelituiala']; ?>&clear=true" class="btn btn-success w-100" style="margin: 5px;">Update</a>
                        ...
                        <table class = "table">
                            ...
                            foreach($venit_user as $row): 
                                ...
                                <tr>
                                    <td colspan="3" style = "border-top: none; ">
                                        <div class = "d-flex flex-row">
                                            <a href="index.php?edit_venit=<?php echo $row['id_venit']; ?>&clear=true" class="btn btn-success w-100" style="margin: 5px;">Update</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <hr><br>
                <button type="submit" name="save" class="btn btn-primary btn-block" onclick="getElementById('add_membru').style.display ='block'">Adăugare Membru</button>
                <button type="submit" name="save" class="btn btn-primary btn-block" onclick="getElementById('add_venit').style.display ='block'">Adăugare venit</button>
                <button type="submit" name="save" class="btn btn-primary btn-block" onclick="getElementById('add_cheltuiala').style.display ='block'">Adăugare cheltuială</button>
                ...
                <table class = "table">
                    ...
                    <?php 
                        foreach($membri as $row):
                            ...
                            echo "
                                <tr onclick = \"window.location.replace('index.php?get_user_data= ".$row['id_membry']."&name=".$row['nume_membry']."'); \">
                ...
                <div class="d-flex justify-content-between">
                    <div class = "w-100  d-flex flex-column justify-content-center">
                        ...
                        <table class = "table">
                            ...
                            <?php 
                                while($row = $cheltuieli->fetch_assoc()): ?>
                                <tr>
                                    <td><?php echo $row['titlu']; ?></td>
                                    <td class ="text-danger"><?php echo $row['val_cheltuili']; ?> mdl</td>
                                    <td><?php echo $row['date']; ?></td>
                                ...
                                <tr>
                                    <td colspan="3" style = "border-top: none; ">
                                        <div class = "d-flex flex-row">
                                            <a href="index.php?edit_cheltuiala=<?php echo $row['id_chelituiala']; ?>" class="btn btn-success w-100" style="margin: 5px;">Update</a>
                        ...
                        <table class = "table">
                            ...
                            <?php 
                                ...
                                <tr>
                                    <td colspan="3" style = "border-top: none; ">
                                        <div class = "d-flex flex-row">
                                            <a href="index.php?edit_venit=<?php echo $row['id_venit']; ?>" class="btn btn-success w-100" style="margin: 5px;">Update</a>
